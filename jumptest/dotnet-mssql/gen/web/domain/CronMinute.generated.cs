...
{
    [ClassInfo("")]
    public partial class CronMinute : BaseObject
    {
        public CronMinute(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "CronMinute";
            tableName = "core.cron_minute";
            schemaName = "core";
            tableBaseName = "cron_minute";
            auditTableName = "core.cron_minute"; // history rows live in the same table (is_active=0)
            isAudited = true;
    ...
    public partial class CronMinuteHistory : CronMinute
    {
        protected override void Initialize()
        {
    ...
    public class CronMinuteView : CronMinute
    {
    }
        }
