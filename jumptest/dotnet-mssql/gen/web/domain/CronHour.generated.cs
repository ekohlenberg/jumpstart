...
{
    [ClassInfo("")]
    public partial class CronHour : BaseObject
    {
        public CronHour(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        protected override void Initialize()
        {
            // Default initializer
            domainName = "CronHour";
            tableName = "core.cron_hour";
            schemaName = "core";
            tableBaseName = "cron_hour";
            auditTableName = "core.cron_hour"; // history rows live in the same table (is_active=0)
            isAudited = true;
    ...
    public partial class CronHourHistory : CronHour
    {
        protected override void Initialize()
        {
    ...
    public class CronHourView : CronHour
    {
    }
        }
