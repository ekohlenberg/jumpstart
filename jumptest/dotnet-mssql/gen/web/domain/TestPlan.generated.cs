...
{
    [ClassInfo("Test Plan")]
    public partial class TestPlan : BaseObject
    {
        public TestPlan(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        protected override void Initialize()
        {
            // Default initializer
            domainName = "TestPlan";
            tableName = "app.test_plan";
            schemaName = "app";
            tableBaseName = "test_plan";
            auditTableName = "app.test_plan"; // history rows live in the same table (is_active=0)
            isAudited = true;
    ...
    public partial class TestPlanHistory : TestPlan
    {
        protected override void Initialize()
        {
    ...
    public class TestPlanView : TestPlan
    {
    }
        }
