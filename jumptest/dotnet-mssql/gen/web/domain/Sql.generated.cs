...
namespace jumptest
{
    ...
    public partial class Sql : BaseObject
    {
        ...
        protected override void Initialize()
        {
            ...
            schemaName = "core";
            tableBaseName = "sql";
            auditTableName = "core.sql"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            [ColumnInfo("Data Source ID", "DataSource", "enum", "data_source", "datasource", false)]
