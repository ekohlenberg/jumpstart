...
namespace jumptest
{
    [ClassInfo("Operation Role")]
    public partial class OpRole : BaseObject
    {
        public OpRole(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        protected override void Initialize()
        {
            // Default initializer
            domainName = "OpRole";
            tableName = "core.op_role";
            schemaName = "core";
            tableBaseName = "op_role";
            auditTableName = "core.op_role"; // history rows live in the same table (is_active=0)
            isAudited = true;
    ...
    public partial class OpRoleHistory : OpRole
    {
        protected override void Initialize()
        {
    ...
    public class OpRoleView : OpRole
    {
    }
        }
