...
{
    /// <summary>
    /// Exports all rows from core.op_role_member to a CSV file.
    /// </summary>
    public static class OpRoleMemberExporter
    {
        public static int Export(string outputPath)
        {
            var records = OpRoleMemberLogic.Create().select<OpRoleMember>();
