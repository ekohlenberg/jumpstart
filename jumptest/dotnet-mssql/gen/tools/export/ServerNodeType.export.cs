...
{
    /// <summary>
    /// Exports all rows from core.server_node_type to a CSV file.
    /// </summary>
    public static class ServerNodeTypeExporter
    {
        public static int Export(string outputPath)
        {
            var records = ServerNodeTypeLogic.Create().select<ServerNodeType>();
