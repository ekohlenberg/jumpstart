...
{
    /// <summary>
    /// Exports all rows from core.event_service to a CSV file.
    /// </summary>
    public static class EventServiceExporter
    {
        public static int Export(string outputPath)
        {
            var records = EventServiceLogic.Create().select<EventService>();
            ...
            foreach (var record in records)
            {
                ...
                csv.WriteField(record.script_id);
