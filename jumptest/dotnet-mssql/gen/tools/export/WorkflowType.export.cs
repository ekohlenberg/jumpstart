...
{
    /// <summary>
    /// Exports all rows from core.workflow_type to a CSV file.
    /// </summary>
    public static class WorkflowTypeExporter
    {
        public static int Export(string outputPath)
        {
            var records = WorkflowTypeLogic.Create().select<WorkflowType>();
