...
namespace jumptest
{
    ...
    public interface IProcessLogic 
    {
        ...
        void delete( long id );
        ProcessView view(long id);
        
    
    }

    public partial class ProcessLogic : BaseLogic, IProcessLogic
    {

        /// <summary>
        /// Creates and initializes a proxy instance of the logic implementation for the domain object.
        /// </summary>
        /// <returns>An initialized proxy implementing <see cref="IProcessLogic"/>.</returns>
        ...
        /// </summary>
        /// <returns>A direct <see cref="ProcessLogic"/> instance implementing <see cref="IProcessLogic"/>.</returns>
        public static IProcessLogic Unsafe()
        {
            return new ProcessLogic();
        }

        /// <summary>
        /// Selects all domain objects using the default return type of the domain object.
        /// </summary>
        /// <returns>List of <see cref="Process"/> instances.</returns>
        public virtual List<Process> select()
        {
        ...
        /// <returns>List of <see cref="ProcessHistory"/> entries associated with the given id.</returns>
        public virtual List<ProcessHistory> history(long id)
        {
            ...
            List<ProcessHistory> processHistory = DBPersist.select<ProcessHistory>(
                $"SELECT * FROM core.process WHERE id = {id} ORDER BY txn_id DESC");
        ...
        /// for how the "core.process-map-{mapSuffix}" query is generated.
        /// </summary>
        ...
        {
            Logger.Debug($"Processing ProcessLogic maplist for ID={id}, mapSuffix={mapSuffix}");

            string queryName = "core.process-map-" + mapSuffix;
        ...
        /// <returns>An instance of <see cref="Process"/> if found; otherwise <c>null</c>.</returns>
        public virtual Process get(long id)
        {
            Logger.Debug($"Processing ProcessLogic get ID={id}");

            Process process = DBPersist.select<Process>($"SELECT * FROM core.process WHERE id = {id} AND is_active = 1").FirstOrDefault();
        ...
        public virtual ProcessView view(long id) 
        {
            Logger.Debug($"Processing ProcessLogic view<TBaseObject> ID={id}");

            string queryName = "core.process-get";
            List<ProcessView> ProcessView = DBPersist.ExecuteQueryByName<ProcessView>(queryName, new BaseObject() { { "id", id } });
            

            return ProcessView.FirstOrDefault();
        }
        /// <summary>
        /// Inserts a new domain object into persistence.
        /// </summary>
        /// <param name="process">The domain object instance to insert.</param>
        public virtual void insert(Process process)
        {
        ...
        /// </summary>
        /// <param name="process">The domain object instance to put.</param>
        public virtual void put(Process process)
        {
        ...
        /// <param name="process">The updated domain object instance.</param>
        public virtual void update(long id, Process process)
        {
