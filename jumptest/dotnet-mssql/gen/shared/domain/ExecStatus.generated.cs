...
namespace jumptest
{
    [ClassInfo("Execution Status")]
    public partial class ExecStatus : BaseObject
    {
        public ExecStatus(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "ExecStatus";
            tableName = "core.exec_status";
            schemaName = "core";
            tableBaseName = "exec_status";
            auditTableName = "core.exec_status"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            _defaults["image"] = default(string);
            ...
            [ColumnInfo("Exec Status ID", "", "", "", "", false)]
            public long id
            {
                get
                {
            ...
            public string image
            {
                get
                {
                    ...
                    try
                    {
                        ...
                        {
                        _image = Convert.ToString(this["image"].ToString());
                        }
                    }
                    catch(Exception )
                    {
                        //Logger.Error($"Error getting image: {e.Message}");
                        _image = default(string);
                    }
                    return _image;
                }
                set
    ...
    public partial class ExecStatusHistory : ExecStatus
    {
        protected override void Initialize()
        {
    ...
    public class ExecStatusView : ExecStatus
    {
    }
        }
