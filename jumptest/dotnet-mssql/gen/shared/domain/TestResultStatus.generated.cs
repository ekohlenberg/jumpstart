...
namespace jumptest
{
    [ClassInfo("Test Result Status")]
    public partial class TestResultStatus : BaseObject
    {
        public TestResultStatus(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "TestResultStatus";
            tableName = "app.test_result_status";
            schemaName = "app";
            tableBaseName = "test_result_status";
            auditTableName = "app.test_result_status"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            [ColumnInfo("Test Result Status ID", "", "", "", "", false)]
            public long id
            {
                get
                {
    ...
    public partial class TestResultStatusHistory : TestResultStatus
    {
        protected override void Initialize()
        {
            ...
            base.Initialize();
            domainName = "TestResultStatusHistory";
    ...
    public class TestResultStatusView : TestResultStatus
    {
    }
        }
