...
namespace jumptest
{
    [ClassInfo("Server Node Type")]
    public partial class ServerNodeType : BaseObject
    {
        public ServerNodeType(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "ServerNodeType";
            tableName = "core.server_node_type";
            schemaName = "core";
            tableBaseName = "server_node_type";
            auditTableName = "core.server_node_type"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            [ColumnInfo("Server Node Type ID", "", "", "", "", false)]
            public long id
            {
                get
                {
    ...
    public partial class ServerNodeTypeHistory : ServerNodeType
    {
        protected override void Initialize()
        {
            ...
            base.Initialize();
            domainName = "ServerNodeTypeHistory";
    ...
    public class ServerNodeTypeView : ServerNodeType
    {
    }
        }
