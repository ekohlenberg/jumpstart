...
{
    [ClassInfo("")]
    public partial class CronDom : BaseObject
    {
        public CronDom(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        protected override void Initialize()
        {
            // Default initializer
            domainName = "CronDom";
            tableName = "core.cron_dom";
            schemaName = "core";
            tableBaseName = "cron_dom";
            auditTableName = "core.cron_dom"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            [ColumnInfo("Day Of Month ID", "", "", "", "", false)]
            public long id
            {
                get
                {
    ...
    public partial class CronDomHistory : CronDom
    {
        protected override void Initialize()
        {
    ...
    public class CronDomView : CronDom
    {
    }
        }
