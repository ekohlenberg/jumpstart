...
{
    [ClassInfo("")]
    public partial class CronDow : BaseObject
    {
        public CronDow(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        protected override void Initialize()
        {
            // Default initializer
            domainName = "CronDow";
            tableName = "core.cron_dow";
            schemaName = "core";
            tableBaseName = "cron_dow";
            auditTableName = "core.cron_dow"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            [ColumnInfo("Day Of Week ID", "", "", "", "", false)]
            public long id
            {
                get
                {
    ...
    public partial class CronDowHistory : CronDow
    {
        protected override void Initialize()
        {
    ...
    public class CronDowView : CronDow
    {
    }
        }
