...
namespace jumptest
{
    [ClassInfo("Workflow Type")]
    public partial class WorkflowType : BaseObject
    {
        public WorkflowType(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "WorkflowType";
            tableName = "core.workflow_type";
            schemaName = "core";
            tableBaseName = "workflow_type";
            auditTableName = "core.workflow_type"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            [ColumnInfo("Workflow Type ID", "", "", "", "", false)]
            public long id
            {
                get
                {
    ...
    public partial class WorkflowTypeHistory : WorkflowType
    {
        protected override void Initialize()
        {
            ...
            base.Initialize();
            domainName = "WorkflowTypeHistory";
    ...
    public class WorkflowTypeView : WorkflowType
    {
    }
        }
