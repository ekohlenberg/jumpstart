...
{
    [ClassInfo("")]
    public partial class CronEvery : BaseObject
    {
        public CronEvery(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "CronEvery";
            tableName = "core.cron_every";
            schemaName = "core";
            tableBaseName = "cron_every";
            auditTableName = "core.cron_every"; // history rows live in the same table (is_active=0)
            isAudited = true;
    ...
    public partial class CronEveryHistory : CronEvery
    {
        protected override void Initialize()
        {
    ...
    public class CronEveryView : CronEvery
    {
    }
        }
