...
namespace jumptest
{
    [ClassInfo("Server Node Status")]
    public partial class ServerNodeStatus : BaseObject
    {
        public ServerNodeStatus(BaseObject baseObject) : base(baseObject)
        {
            Initialize();
        }
        ...
        {
            // Default initializer
            domainName = "ServerNodeStatus";
            tableName = "core.server_node_status";
            schemaName = "core";
            tableBaseName = "server_node_status";
            auditTableName = "core.server_node_status"; // history rows live in the same table (is_active=0)
            isAudited = true;
            ...
            [ColumnInfo("Server Node Status ID", "", "", "", "", false)]
            public long id
            {
                get
                {
    ...
    public partial class ServerNodeStatusHistory : ServerNodeStatus
    {
        protected override void Initialize()
        {
            ...
            base.Initialize();
            domainName = "ServerNodeStatusHistory";
    ...
    public class ServerNodeStatusView : ServerNodeStatus
    {
    }
        }
