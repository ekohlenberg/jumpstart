// Hand-written override of the generated gen/web/src/App.tsx (FORCE=FALSE
// equivalent for the web-nodejs output -- see gen/web/makefile's
// `cp -r -f ../../usr/web/. $(TARGETDIR)` step, which layers this file over
// the generated one in bin/web after the generated project is built).
//
// Identical to the generated App.tsx except for one addition: the
// "/usr/testplan" route, mirroring how "/core/workflow" -> ListWorkflowCore
// is wired for the built-in workflow object (see
// templates/web/nodejs/src/App.tsx.cshtml). It points at the same
// ListTestPlan import as the default "/testplan" route -- the component
// behind that import is usr/web/src/pages/ListTestPlan.tsx (this project's
// hand-written replacement for the generated page of the same name; no
// "Core" suffix needed since it fully supersedes the generated version
// rather than coexisting alongside it). The test_plan table's URI column
// ("usr/testplan") points the nav menu at the new route.
//
// NOTE: if jumptest.csv gains/loses domain objects, re-diff this file
// against a freshly generated gen/web/src/App.tsx and re-apply this file's
// one addition (the "/usr/testplan" <Route>) to the new generated routes.
          ...
          <ProtectedRoute>
            <MainLayout>
              <Routes>
                ...
                <Route path="/usr/testplan" element={<ListTestPlan />} />
