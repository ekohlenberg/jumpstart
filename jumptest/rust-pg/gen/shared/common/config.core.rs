...
// ~/.jumptest.json and builds connection strings. The legacy
// colon-delimited ~/.jumptest format is also supported.
// </auto-generated>
...
pub const NAMESPACE: &str = "jumptest";
