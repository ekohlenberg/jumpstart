...
const FORM_FIELDS: FormField[] = [
  { key: "id", label: "Workflow ID", kind: "number", fkVar: "" },
  { key: "workflow_type_id", label: "Type", kind: "enum", fkVar: "workflowtype" },
  { key: "parent_id", label: "Parent", kind: "enum", fkVar: "workflow" },
  { key: "name", label: "Name", kind: "string", fkVar: "" },
  { key: "seq", label: "Sequence", kind: "number", fkVar: "" },
  { key: "server_node_id", label: "Agent", kind: "enum", fkVar: "servernode" },
  { key: "process_id", label: "Process", kind: "enum", fkVar: "process" },
  { key: "exec_status_id", label: "Status", kind: "enum", fkVar: "execstatus" },
  { key: "last_start_time", label: "Last Start Time", kind: "date", fkVar: "" },
  { key: "last_end_time", label: "LastEnd Time", kind: "date", fkVar: "" },
  { key: "schedule_id", label: "Schedule", kind: "enum", fkVar: "schedule" },
  { key: "on_failure_action_id", label: "On Failure", kind: "enum", fkVar: "onfailure" },
