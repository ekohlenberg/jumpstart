...
const FORM_FIELDS: FormField[] = [
  { key: "id", label: "Test Result ID", kind: "number", fkVar: "" },
  { key: "test_run_id", label: "Test Run", kind: "enum", fkVar: "testrun" },
  { key: "test_case_id", label: "Test Case", kind: "enum", fkVar: "testcase" },
  { key: "test_result_status_id", label: "Status", kind: "enum", fkVar: "testresultstatus" },
  { key: "executed_at", label: "Executed At", kind: "date", fkVar: "" },
  { key: "executed_by", label: "Executed By", kind: "string", fkVar: "" },
  { key: "actual_result", label: "Actual Result", kind: "string", fkVar: "" },
  { key: "notes", label: "Notes", kind: "string", fkVar: "" },
