...
const FORM_FIELDS: FormField[] = [
  { key: "id", label: "Member ID", kind: "number", fkVar: "", isGlobal: false },
  { key: "principal_id", label: "Username", kind: "number", fkVar: "", isGlobal: false },
  { key: "op_role_id", label: "Role", kind: "number", fkVar: "", isGlobal: false },
