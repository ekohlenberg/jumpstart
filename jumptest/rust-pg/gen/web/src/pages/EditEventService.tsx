...
const FORM_FIELDS: FormField[] = [
  { key: "id", label: "Event ID", kind: "number", fkVar: "", isGlobal: false },
  { key: "event_type", label: "Event Type", kind: "string", fkVar: "", isGlobal: false },
  { key: "objectname_filter", label: "Object Filter", kind: "string", fkVar: "", isGlobal: false },
  { key: "methodname_filter", label: "Method Filter", kind: "string", fkVar: "", isGlobal: false },
  { key: "script_id", label: "Script ID", kind: "enum", fkVar: "script", isGlobal: false },
