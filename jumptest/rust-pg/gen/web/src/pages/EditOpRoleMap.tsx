...
const FORM_FIELDS: FormField[] = [
  { key: "id", label: "Operation Role Map ID", kind: "number", fkVar: "", isGlobal: false },
  { key: "op_id", label: "Operation ID", kind: "number", fkVar: "", isGlobal: false },
  { key: "op_role_id", label: "Role ID", kind: "number", fkVar: "", isGlobal: false },
