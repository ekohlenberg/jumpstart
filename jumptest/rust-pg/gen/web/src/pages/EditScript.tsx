...
const FORM_FIELDS: FormField[] = [
  { key: "id", label: "Script ID", kind: "number", fkVar: "", isGlobal: false },
  { key: "name", label: "Name", kind: "string", fkVar: "", isGlobal: false },
  { key: "source", label: "Source Code", kind: "string", fkVar: "", isGlobal: false },
  { key: "script_type_id", label: "Script Type", kind: "enum", fkVar: "scripttype", isGlobal: false },
