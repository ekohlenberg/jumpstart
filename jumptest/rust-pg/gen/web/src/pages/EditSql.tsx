...
const FORM_FIELDS: FormField[] = [
  { key: "id", label: "Query ID", kind: "number", fkVar: "" },
  { key: "name", label: "Name", kind: "string", fkVar: "" },
  { key: "data_source_id", label: "Data Source ID", kind: "enum", fkVar: "datasource" },
  { key: "sql_text", label: "SQL Text", kind: "string", fkVar: "" },
