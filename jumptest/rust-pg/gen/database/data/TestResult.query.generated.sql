...
SELECT n, n,
    ...
    'Select all TestResult records with related TestRun, TestCase, TestResultStatus information',
    NOW(),
    CURRENT_USER,
    1,
...
SELECT n, n,
    ...
    'Select single TestResult record by ID with related TestRun, TestCase, TestResultStatus information',
    NOW(),
    CURRENT_USER,
    1,
    (SELECT id FROM core.data_source WHERE name = 'default' AND is_active = 1)
...
SELECT n, n,
    ...
    'Select single TestResult record by RWK columns with related TestRun, TestCase, TestResultStatus information',
    NOW(),
    CURRENT_USER,
    1,
    (SELECT id FROM core.data_source WHERE name = 'default' AND is_active = 1)
