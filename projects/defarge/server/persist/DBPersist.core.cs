...
namespace defarge
{
    public class DBPersist
    {
        ...
        static public long insert( BaseObject baseObject )
        {
            ...
            baseObject.setPropValue("id", id);
            baseObject.setPropValue("version", ver);
            baseObject.setPropValue("created_by", Environment.UserName);
            baseObject.setPropValue("last_updated", DateTime.Now);
            baseObject.setPropValue("last_updated_by", Environment.UserName);
        ...
        static public long audit( BaseObject baseObject )
        {
            ...
            auditBaseObject.setPropValue(auditFKCol, baseObject["id"]);
            long id = identity(baseObject);
            auditBaseObject.setPropValue("id", id);
        ...
        {
            baseObject.setPropValue("version", version(baseObject));
            baseObject.setPropValue("last_updated", DateTime.Now);
            baseObject.setPropValue("last_updated_by", Environment.UserName);
