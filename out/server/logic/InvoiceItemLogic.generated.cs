...
namespace legr
{
    public partial class InvoiceItemLogic : Logic
    {
        ...
        {
            Console.WriteLine("Processing InvoiceItemLogic get ID=" + id.ToString());
        ...
        {
            Console.WriteLine("Processing InvoiceItemLogic insert: " + invoiceitem.ToString()  );

            invoiceitem.is_active = "Y";
        ...
        {
            Console.WriteLine("Processing InvoiceItemLogic update: ID = " + id.ToString() + "\n" + invoiceitem.ToString()  );
