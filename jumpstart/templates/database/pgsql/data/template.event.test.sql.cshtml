INSERT INTO core.script(
	...
	VALUES (nextval('core.script_identity'), 'all-object insert event', 'Console.WriteLine("all-object insert event");', 1, current_user, current_timestamp, current_user, 1);

INSERT INTO core.script(
	id, name, source, is_active, created_by, last_updated, last_updated_by, version)
	VALUES (nextval('core.script_identity'), 'all-object update event', 'Console.WriteLine("all-object update event");', 1, current_user, current_timestamp, current_user, 1);
